...
export default function Home() {
  return (<div className="flex flex-col pt-18">
...
<section id="how-it-works" className="py-20">
          ...
          <div className="mx-auto mt-12 grid max-w-5xl gap-8 md:grid-cols-3">
            {STEPS.map(({ label, title, description }) => (
              <div key={label} className="flex flex-col items-center space-y-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-cyan-100 text-xl font-bold text-cyan-600">
                  {label}
                </div>
                <h3 className="text-xl font-bold">{title}</h3>
      ...
      <section className="py-20 gradient">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          ...
          <Button asChild size="lg" className="bg-cyan-800 hover:opacity-90">
            <Link href="/dashboard">
              Get Started
              <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
